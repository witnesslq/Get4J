...
public final class JavaShellUtil {

	private static final String shell_path = System.getProperty("user.dir") + File.separator + "bin" + File.separator + "swift-env.sh";

	private static final Logger logger = LogManager.getLogger(JavaShellUtil.class);
